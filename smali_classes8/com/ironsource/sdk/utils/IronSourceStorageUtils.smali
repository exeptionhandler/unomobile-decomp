...
.method private static a(Landroid/content/Context;)V
    ...
    sget-object v0, Lcom/ironsource/sdk/utils/IronSourceStorageUtils;->b:Lcom/ironsource/st;

    if-eqz v0, :cond_0

    invoke-virtual {v0}, Lcom/ironsource/st;->b()Z
    ...
    invoke-virtual {v0}, Lcom/ironsource/st;->c()Z
...
.method private static a()Z
    ...
    invoke-virtual {v0}, Lcom/ironsource/st;->a()Z
...
.method private static b(Landroid/content/Context;)Ljava/io/File;
    ...
    sget-object v1, Lcom/ironsource/sdk/utils/IronSourceStorageUtils;->b:Lcom/ironsource/st;

    if-eqz v1, :cond_0

    invoke-virtual {v1}, Lcom/ironsource/st;->d()Z

    move-result v1

    if-eqz v1, :cond_0

    invoke-interface {v0, p0}, Lcom/ironsource/of;->e(Landroid/content/Context;)Ljava/io/File;
    ...
    :cond_0
    invoke-interface {v0, p0}, Lcom/ironsource/of;->u(Landroid/content/Context;)Ljava/io/File;
...
.method public static buildFilesMapOfDirectory(Lcom/ironsource/oh;Lorg/json/JSONObject;)Lorg/json/JSONObject;
    .locals 6
    ...
    invoke-direct {v4, v3}, Lcom/ironsource/oh;-><init>(Ljava/lang/String;)V
    ...
    invoke-static {v4, p1}, Lcom/ironsource/sdk/utils/IronSourceStorageUtils;->buildFilesMapOfDirectory(Lcom/ironsource/oh;Lorg/json/JSONObject;)Lorg/json/JSONObject;
...
.method private static c(Landroid/content/Context;)Ljava/io/File;
    ...
    invoke-interface {v0, p0}, Lcom/ironsource/of;->k(Landroid/content/Context;)Ljava/io/File;
    ...
    :cond_0
    invoke-interface {v0, p0}, Lcom/ironsource/of;->x(Landroid/content/Context;)Ljava/io/File;
...
.method public static declared-synchronized deleteFile(Lcom/ironsource/oh;)Z
    .locals 2
...
.method public static ensurePathSafety(Ljava/io/File;Ljava/lang/String;)V
    ...
    invoke-virtual {v0}, Lcom/ironsource/st;->e()Z
...
.method public static getFilesInFolderRecursive(Lcom/ironsource/oh;)Ljava/util/ArrayList;
    .locals 5
    ...
    invoke-static {v4}, Lcom/ironsource/sdk/utils/IronSourceStorageUtils;->getFilesInFolderRecursive(Lcom/ironsource/oh;)Ljava/util/ArrayList;
...
.method public static getTotalSizeOfDir(Lcom/ironsource/oh;)J
    .locals 6
    ...
    invoke-direct {v5, v4}, Lcom/ironsource/oh;-><init>(Ljava/lang/String;)V
    ...
    invoke-static {v5}, Lcom/ironsource/sdk/utils/IronSourceStorageUtils;->getTotalSizeOfDir(Lcom/ironsource/oh;)J
...
.method public static initializeCacheDirectory(Landroid/content/Context;Lcom/ironsource/st;)V
    .locals 0

    sput-object p1, Lcom/ironsource/sdk/utils/IronSourceStorageUtils;->b:Lcom/ironsource/st;
...
.method public static readFile(Lcom/ironsource/oh;)Ljava/lang/String;
    .locals 3
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/lang/Exception;
