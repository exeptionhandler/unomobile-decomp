...
.method public constructor <init>(JLandroid/app/Activity;)V
    ...
    invoke-static {p3, p1}, Lcom/inmobi/media/H$$ExternalSyntheticApiModelOutline0;->m(Landroid/app/Activity;Ljava/lang/Class;)Ljava/lang/Object;
    ...
    invoke-static {p1}, Lcom/google/android/gms/common/util/zzb$$ExternalSyntheticApiModelOutline0;->m(Landroid/view/Display;)Landroid/view/Display$Mode;
    ...
    invoke-static {p1, p2}, Lcom/inmobi/media/H$$ExternalSyntheticApiModelOutline0;->m(Landroid/app/Activity;Ljava/lang/Class;)Ljava/lang/Object;
...
.method private modeMatchesCurrentResolution(Landroid/view/Display$Mode;)Z
    ...
    invoke-static {p1}, Lcom/google/android/gms/common/util/zzb$$ExternalSyntheticApiModelOutline0;->m$1(Landroid/view/Display$Mode;)I

    move-result v0

    iget-object v1, p0, Lcom/google/androidgamesdk/SwappyDisplayManager;->mCurrentMode:Landroid/view/Display$Mode;

    invoke-static {v1}, Lcom/google/android/gms/common/util/zzb$$ExternalSyntheticApiModelOutline0;->m$1(Landroid/view/Display$Mode;)I

    move-result v1

    if-ne v0, v1, :cond_0

    invoke-static {p1}, Lcom/google/android/gms/common/util/zzb$$ExternalSyntheticApiModelOutline0;->m(Landroid/view/Display$Mode;)I

    move-result p1

    iget-object v0, p0, Lcom/google/androidgamesdk/SwappyDisplayManager;->mCurrentMode:Landroid/view/Display$Mode;

    invoke-static {v0}, Lcom/google/android/gms/common/util/zzb$$ExternalSyntheticApiModelOutline0;->m(Landroid/view/Display$Mode;)I
...
.method private updateSupportedRefreshRates(Landroid/view/Display;)V
    ...
    invoke-static {p1}, Lcom/inmobi/media/H$$ExternalSyntheticApiModelOutline0;->m(Landroid/view/Display;)[Landroid/view/Display$Mode;
    ...
    invoke-static {v4}, Lcom/inmobi/media/H$$ExternalSyntheticApiModelOutline0;->m(Landroid/view/Display$Mode;)F
    ...
    invoke-static {v4}, Lcom/inmobi/media/H$$ExternalSyntheticApiModelOutline0;->m(Landroid/view/Display$Mode;)I
...
.method public onDisplayChanged(I)V
    ...
    invoke-static {v1}, Lcom/google/android/gms/common/util/zzb$$ExternalSyntheticApiModelOutline0;->m(Landroid/view/Display$Mode;)I

    move-result v2

    iget-object v3, p0, Lcom/google/androidgamesdk/SwappyDisplayManager;->mCurrentMode:Landroid/view/Display$Mode;

    invoke-static {v3}, Lcom/google/android/gms/common/util/zzb$$ExternalSyntheticApiModelOutline0;->m(Landroid/view/Display$Mode;)I
    ...
    invoke-static {v6}, Lcom/google/android/gms/common/util/zzb$$ExternalSyntheticApiModelOutline0;->m$1(Landroid/view/Display$Mode;)I
    ...
    invoke-static {v3}, Lcom/inmobi/media/H$$ExternalSyntheticApiModelOutline0;->m(Landroid/view/Display$Mode;)F
