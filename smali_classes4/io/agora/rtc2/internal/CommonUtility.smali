...
.field private static gatewayIp:Ljava/net/InetAddress;
...
# instance fields
.field private final PHONE_STATE_PERMISSION_CHECK_MAX_CNT:I

.field private final PHONE_STATE_PERMISSION_TIMEOUT_MS:I

.field private final WARN_ADM_REG_PHONE_LISTENNER_FAILED:I

.field private final checkPermissionRunnable:Ljava/lang/Runnable;
...
.field private mCheckTimerCount:I
...
.field private mPhoneListenerRegistered:Z
...
.method public constructor <init>(Landroid/content/Context;J)V
    ...
    iput-object v0, p0, Lio/agora/rtc2/internal/CommonUtility;->mobileNetworkCallback:Landroid/net/ConnectivityManager$NetworkCallback;

    const/16 v1, 0xff

    iput v1, p0, Lio/agora/rtc2/internal/CommonUtility;->mBatteryPercentage:I

    const/4 v1, 0x0

    iput-boolean v1, p0, Lio/agora/rtc2/internal/CommonUtility;->mDisposed:Z
    ...
    iput-boolean v1, p0, Lio/agora/rtc2/internal/CommonUtility;->mPhoneListenerRegistered:Z

    const/16 v1, 0x7d0

    iput v1, p0, Lio/agora/rtc2/internal/CommonUtility;->PHONE_STATE_PERMISSION_TIMEOUT_MS:I

    const/16 v1, 0xf

    iput v1, p0, Lio/agora/rtc2/internal/CommonUtility;->PHONE_STATE_PERMISSION_CHECK_MAX_CNT:I

    const/16 v1, 0x424

    iput v1, p0, Lio/agora/rtc2/internal/CommonUtility;->WARN_ADM_REG_PHONE_LISTENNER_FAILED:I
    ...
    iput-boolean v0, p0, Lio/agora/rtc2/internal/CommonUtility;->shouldGetIp:Z

    new-instance v0, Lio/agora/rtc2/internal/CommonUtility$2;

    invoke-direct {v0, p0}, Lio/agora/rtc2/internal/CommonUtility$2;-><init>(Lio/agora/rtc2/internal/CommonUtility;)V

    iput-object v0, p0, Lio/agora/rtc2/internal/CommonUtility;->checkPermissionRunnable:Ljava/lang/Runnable;
...
.method static synthetic access$000(Lio/agora/rtc2/internal/CommonUtility;)I
    .locals 0

    iget p0, p0, Lio/agora/rtc2/internal/CommonUtility;->mCheckTimerCount:I

    return p0
.end method

.method static synthetic access$010(Lio/agora/rtc2/internal/CommonUtility;)I
    .locals 2

    iget v0, p0, Lio/agora/rtc2/internal/CommonUtility;->mCheckTimerCount:I

    add-int/lit8 v1, v0, -0x1

    iput v1, p0, Lio/agora/rtc2/internal/CommonUtility;->mCheckTimerCount:I

    return v0
.end method

.method static synthetic access$100(Lio/agora/rtc2/internal/CommonUtility;)V
    .locals 0

    invoke-direct {p0}, Lio/agora/rtc2/internal/CommonUtility;->cancelTimer()V

    return-void
.end method

.method static synthetic access$200(Lio/agora/rtc2/internal/CommonUtility;I)V
    .locals 0

    invoke-direct {p0, p1}, Lio/agora/rtc2/internal/CommonUtility;->nativeNotifyCommonUtilityEvent(I)V

    return-void
.end method

.method static synthetic access$300(Lio/agora/rtc2/internal/CommonUtility;)V
    .locals 0

    invoke-direct {p0}, Lio/agora/rtc2/internal/CommonUtility;->startTimer()V

    return-void
.end method

.method static synthetic access$400(Lio/agora/rtc2/internal/CommonUtility;)V
    .locals 0
...
.method static synthetic access$500()Landroid/os/Handler;
    ...
    sget-object v0, Lio/agora/rtc2/internal/CommonUtility;->mProcessInfoHandler:Landroid/os/Handler;
...
.method static synthetic access$502(Landroid/os/Handler;)Landroid/os/Handler;
    ...
    sput-object p0, Lio/agora/rtc2/internal/CommonUtility;->mProcessInfoHandler:Landroid/os/Handler;

    return-object p0
.end method

.method static synthetic access$600(Lio/agora/rtc2/internal/CommonUtility;)Landroid/os/Handler;
    .locals 0
...
.method static synthetic access$700(Ljava/net/InetAddress;)Ljava/lang/String;
    .locals 0

    invoke-static {p0}, Lio/agora/rtc2/internal/CommonUtility;->inetAddressToIpAddress(Ljava/net/InetAddress;)Ljava/lang/String;
...
.method private cancelTimer()V
    ...
    const-string v1, "cancel check timer"

    invoke-static {v0, v1}, Lio/agora/rtc2/internal/Logging;->d(Ljava/lang/String;Ljava/lang/String;)V

    iget-object v0, p0, Lio/agora/rtc2/internal/CommonUtility;->mHandler:Landroid/os/Handler;

    iget-object v1, p0, Lio/agora/rtc2/internal/CommonUtility;->checkPermissionRunnable:Ljava/lang/Runnable;
...
.method public static getAppNativeLibDir(Landroid/content/Context;)Ljava/lang/String;
    .locals 5
    .annotation system Ldalvik/annotation/MethodParameters;
        accessFlags = {
            0x0
    ...
    const-string/jumbo v4, "split_config"
...
.method public static getLocalHostList()[Ljava/lang/String;
    ...
    invoke-static {v4}, Lio/agora/rtc2/internal/CommonUtility;->inetAddressToIpAddress(Ljava/net/InetAddress;)Ljava/lang/String;
...
.method private getNetworkInfo(Landroid/content/Context;)Lio/agora/rtc2/internal/CommonUtility$MediaNetworkInfo;
    ...
    :cond_0
    iget-boolean v1, p0, Lio/agora/rtc2/internal/CommonUtility;->shouldGetIp:Z
    ...
    iput-object v1, p0, Lio/agora/rtc2/internal/CommonUtility;->lastLocalIp4:Ljava/lang/String;
    ...
    iput-object v3, p0, Lio/agora/rtc2/internal/CommonUtility;->lastLocalIp6:Ljava/lang/String;

    const/4 v3, 0x0

    sput-object v3, Lio/agora/rtc2/internal/CommonUtility;->gatewayIp:Ljava/net/InetAddress;

    iput-boolean v1, p0, Lio/agora/rtc2/internal/CommonUtility;->shouldGetIp:Z

    :cond_1
    iget-object v1, p0, Lio/agora/rtc2/internal/CommonUtility;->lastLocalIp4:Ljava/lang/String;
    ...
    :cond_2
    iget-object v1, p0, Lio/agora/rtc2/internal/CommonUtility;->lastLocalIp6:Ljava/lang/String;
...
.method public static isAppInForeground()Z
    ...
    new-instance v3, Lio/agora/rtc2/internal/CommonUtility$8;

    invoke-direct {v3, v0, v1}, Lio/agora/rtc2/internal/CommonUtility$8;-><init>(Landroid/app/ActivityManager$RunningAppProcessInfo;Ljava/util/concurrent/CountDownLatch;)V

    sget-object v4, Lio/agora/rtc2/internal/CommonUtility;->mProcessInfoHandler:Landroid/os/Handler;
    ...
    sput-object v5, Lio/agora/rtc2/internal/CommonUtility;->mProcessInfoHandler:Landroid/os/Handler;
...
.method public static isSimulator()Z
    ...
    :goto_0
    invoke-static {}, Lio/agora/rtc2/internal/CommonUtility;->isSimulatorProperty()Z
...
.method private static isSimulatorProperty()Z
    ...
    invoke-static {v6}, Lio/agora/rtc2/internal/CommonUtility;->getSystemProperty(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v1, v7}, Lio/agora/rtc2/internal/Logging;->e(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {v1, v9}, Lio/agora/rtc2/internal/Logging;->e(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {v9}, Lio/agora/rtc2/internal/CommonUtility;->getSystemProperty(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v1, v10}, Lio/agora/rtc2/internal/Logging;->e(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {v10}, Lio/agora/rtc2/internal/CommonUtility;->getSystemProperty(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v1, v11}, Lio/agora/rtc2/internal/Logging;->e(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {v11}, Lio/agora/rtc2/internal/CommonUtility;->getSystemProperty(Ljava/lang/String;)Ljava/lang/String;
    ...
    const-string/jumbo v11, "suspectCount = "
...
.method private native nativeNotifyCommonUtilityEvent(I)V
    .annotation system Ldalvik/annotation/MethodParameters;
        accessFlags = {
            0x0
        }
...
.method private startTimer()V
    ...
    const-string/jumbo v1, "start check timer "
...
.method private stopMonitor()V
    ...
    const-string/jumbo v0, "stopMonitor()"
    ...
    const-string/jumbo v2, "unregister ProcessLifecycleOwner failed "
...
.method public VPNBehindAddress()I
    ...
    :cond_0
    invoke-static {v0}, Lio/agora/rtc2/internal/Connectivity;->VPNBehindAddress(Landroid/content/Context;)I
...
.method public bindSocket2Network(ILjava/lang/String;)V
    ...
    iget-object p2, p0, Lio/agora/rtc2/internal/CommonUtility;->mobileNetworkCallback:Landroid/net/ConnectivityManager$NetworkCallback;
    ...
    :cond_0
    new-instance p2, Lio/agora/rtc2/internal/CommonUtility$6;
    ...
    invoke-direct/range {v1 .. v6}, Lio/agora/rtc2/internal/CommonUtility$6;-><init>(Lio/agora/rtc2/internal/CommonUtility;Landroid/net/ConnectivityManager;Ljava/lang/String;ILio/agora/rtc2/internal/CommonUtility;)V

    iput-object p2, p0, Lio/agora/rtc2/internal/CommonUtility;->mobileNetworkCallback:Landroid/net/ConnectivityManager$NetworkCallback;
    ...
    invoke-static {p2, p1}, Lio/agora/rtc2/internal/Logging;->e(Ljava/lang/String;Ljava/lang/String;)V
...
.method public dispose()V
    ...
    invoke-direct {v2, p0}, Lio/agora/rtc2/internal/CommonUtility$3;-><init>(Lio/agora/rtc2/internal/CommonUtility;)V

    invoke-virtual {v1, v2}, Landroid/os/Handler;->post(Ljava/lang/Runnable;)Z

    sget-object v1, Lio/agora/rtc2/internal/CommonUtility;->mProcessInfoHandler:Landroid/os/Handler;

    if-eqz v1, :cond_1

    new-instance v2, Lio/agora/rtc2/internal/CommonUtility$4;

    invoke-direct {v2, p0}, Lio/agora/rtc2/internal/CommonUtility$4;-><init>(Lio/agora/rtc2/internal/CommonUtility;)V
    ...
    new-instance v2, Lio/agora/rtc2/internal/CommonUtility$5;

    invoke-direct {v2, p0, v1}, Lio/agora/rtc2/internal/CommonUtility$5;-><init>(Lio/agora/rtc2/internal/CommonUtility;Ljava/util/concurrent/CountDownLatch;)V
...
.method getProcessLifecycleOwner()Lio/agora/rtc2/internal/ProcessLifecycleOwner;
    .locals 1
...
.method public notifyAddressBound(Ljava/lang/String;)V
    ...
    invoke-direct {p0, p1}, Lio/agora/rtc2/internal/CommonUtility;->nativeNotifyAddressBound(Ljava/lang/String;)V
...
.method registerPhoneStateListener()Z
    .locals 4
    ...
    iget-object v2, p0, Lio/agora/rtc2/internal/CommonUtility;->mPhoneStateListener:Lio/agora/rtc2/internal/CommonUtility$AgoraPhoneStateListener;
    ...
    iput-boolean v0, p0, Lio/agora/rtc2/internal/CommonUtility;->mPhoneListenerRegistered:Z
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
    ...
    :goto_0
    iget-boolean v0, p0, Lio/agora/rtc2/internal/CommonUtility;->mPhoneListenerRegistered:Z
...
.method setListener(Lio/agora/rtc2/internal/CommonUtility$Listener;)V
    .locals 0
    .annotation system Ldalvik/annotation/MethodParameters;
        accessFlags = {
            0x0
...
.method public setupGravityMonitor()I
    ...
    new-instance v3, Lio/agora/rtc2/internal/CommonUtility$7;

    const/4 v4, 0x2

    invoke-direct {v3, p0, v1, v4}, Lio/agora/rtc2/internal/CommonUtility$7;-><init>(Lio/agora/rtc2/internal/CommonUtility;Landroid/content/Context;I)V
...
.method public setupPermissionMonitor(Z)I
    .locals 0
    .annotation system Ldalvik/annotation/MethodParameters;
        accessFlags = {
            0x0
    ...
    iget-boolean p1, p0, Lio/agora/rtc2/internal/CommonUtility;->mPhoneListenerRegistered:Z

    if-nez p1, :cond_0

    const/16 p1, 0xf

    iput p1, p0, Lio/agora/rtc2/internal/CommonUtility;->mCheckTimerCount:I
...
.method startMonitor()V
    ...
    const-string/jumbo v0, "startMonitor()"
    ...
    iput-boolean v2, p0, Lio/agora/rtc2/internal/CommonUtility;->mPhoneListenerRegistered:Z

    invoke-virtual {p0}, Lio/agora/rtc2/internal/CommonUtility;->registerPhoneStateListener()Z
