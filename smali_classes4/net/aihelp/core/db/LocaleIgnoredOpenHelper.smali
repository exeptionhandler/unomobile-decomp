...
.method private getDatabaseLocked()Landroid/database/sqlite/SQLiteDatabase;
    ...
    iget-object v4, p0, Lnet/aihelp/core/db/LocaleIgnoredOpenHelper;->mErrorHandler:Landroid/database/DatabaseErrorHandler;

    const v5, 0x10000010

    invoke-static {v1, v2, v5, v4}, Landroid/database/sqlite/SQLiteDatabase;->openDatabase(Ljava/lang/String;Landroid/database/sqlite/SQLiteDatabase$CursorFactory;ILandroid/database/DatabaseErrorHandler;)Landroid/database/sqlite/SQLiteDatabase;
