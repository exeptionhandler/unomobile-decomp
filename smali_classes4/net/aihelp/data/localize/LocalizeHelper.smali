...
.method private static getDataAfterLocalizeFailed(I)V
    ...
    new-instance v2, Lnet/aihelp/data/localize/LocalizeHelper$3;

    invoke-direct {v2, p0}, Lnet/aihelp/data/localize/LocalizeHelper$3;-><init>(I)V

    const/4 p0, 0x0

    invoke-virtual {v1, v0, p0, v2}, Lnet/aihelp/core/net/http/AIHelpRequest;->requestGetByAsync(Ljava/lang/String;Lorg/json/JSONObject;Lnet/aihelp/core/net/http/callback/BaseCallback;)V
