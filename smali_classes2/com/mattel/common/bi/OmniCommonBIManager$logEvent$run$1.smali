.class public final Lcom/mattel/common/bi/OmniCommonBIManager$logEvent$run$1;
...
.annotation system Ldalvik/annotation/EnclosingMethod;
    value = Lcom/mattel/common/bi/OmniCommonBIManager;->logEvent(Ljava/lang/String;Ljava/lang/String;Ljava/util/Map;Z)V
.end annotation
...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        "com/mattel/common/bi/OmniCommonBIManager$logEvent$run$1",
        "Ljava/lang/Runnable;",
        "run",
        "",
...
.method constructor <init>(Ljava/lang/String;Ljava/util/Map;Ljava/lang/String;Z)V
    ...
    iput-object p1, p0, Lcom/mattel/common/bi/OmniCommonBIManager$logEvent$run$1;->$logType:Ljava/lang/String;

    iput-object p2, p0, Lcom/mattel/common/bi/OmniCommonBIManager$logEvent$run$1;->$data:Ljava/util/Map;

    iput-object p3, p0, Lcom/mattel/common/bi/OmniCommonBIManager$logEvent$run$1;->$tag:Ljava/lang/String;

    iput-boolean p4, p0, Lcom/mattel/common/bi/OmniCommonBIManager$logEvent$run$1;->$forceUpload:Z
...
.method public run()V
    ...
    iget-object v1, p0, Lcom/mattel/common/bi/OmniCommonBIManager$logEvent$run$1;->$logType:Ljava/lang/String;
    ...
    iget-object v3, p0, Lcom/mattel/common/bi/OmniCommonBIManager$logEvent$run$1;->$data:Ljava/util/Map;

    invoke-static {}, Lcom/mattel/common/bi/OmniCommonBIManager;->access$getDeviceInfo$p()Ljava/lang/String;

    move-result-object v4

    invoke-virtual {p0}, Lcom/mattel/common/bi/OmniCommonBIManager$logEvent$run$1;->hashCode()I
    ...
    iget-object v3, p0, Lcom/mattel/common/bi/OmniCommonBIManager$logEvent$run$1;->$tag:Ljava/lang/String;

    iget-object v4, p0, Lcom/mattel/common/bi/OmniCommonBIManager$logEvent$run$1;->$logType:Ljava/lang/String;
    ...
    iget-object v2, p0, Lcom/mattel/common/bi/OmniCommonBIManager$logEvent$run$1;->$tag:Ljava/lang/String;

    iget-object v3, p0, Lcom/mattel/common/bi/OmniCommonBIManager$logEvent$run$1;->$logType:Ljava/lang/String;
    ...
    iget-boolean v3, p0, Lcom/mattel/common/bi/OmniCommonBIManager$logEvent$run$1;->$forceUpload:Z
