...
.method public run()V
    ...
    invoke-virtual {v1, v2, v3}, Lcom/ironsource/de;->a(Ljava/lang/String;Ljava/lang/Object;)V
    ...
    invoke-static {v1}, Lcom/ironsource/mediationsdk/s;->l(Lcom/ironsource/mediationsdk/s;)Lcom/ironsource/bk;
    ...
    invoke-virtual {v1, v2}, Lcom/ironsource/bk;->h(Ljava/lang/String;)V
    ...
    invoke-static {}, Lcom/ironsource/dq;->c()Lcom/ironsource/dq;

    move-result-object v1

    invoke-virtual {v1}, Lcom/ironsource/dq;->a()V
    ...
    invoke-virtual {v0, v2, v3, v4}, Lcom/ironsource/mediationsdk/p;->b(Landroid/content/Context;Ljava/lang/String;Lcom/ironsource/mediationsdk/p$c;)Lcom/ironsource/ms;

    move-result-object v2

    invoke-static {v1, v2}, Lcom/ironsource/mediationsdk/s;->a(Lcom/ironsource/mediationsdk/s;Lcom/ironsource/ms;)Lcom/ironsource/ms;

    iget-object v1, p0, Lcom/ironsource/mediationsdk/s$a;->e:Lcom/ironsource/mediationsdk/s;

    invoke-static {v1}, Lcom/ironsource/mediationsdk/s;->n(Lcom/ironsource/mediationsdk/s;)Lcom/ironsource/ms;
    ...
    invoke-virtual {v1}, Lcom/ironsource/ms;->p()Z
    ...
    invoke-static {v2}, Lcom/ironsource/mediationsdk/s;->n(Lcom/ironsource/mediationsdk/s;)Lcom/ironsource/ms;

    move-result-object v2

    invoke-virtual {v2}, Lcom/ironsource/ms;->c()Lcom/ironsource/s8;
    ...
    invoke-virtual {v1, v2, v3}, Lcom/ironsource/om;->a(Ljava/util/Map;Z)V
    ...
    invoke-static {v2}, Lcom/ironsource/mediationsdk/s;->p(Lcom/ironsource/mediationsdk/s;)Lcom/ironsource/cf;

    move-result-object v2

    invoke-interface {v2, v1}, Lcom/ironsource/cf;->a(Lcom/ironsource/k4;)V
    ...
    invoke-static {v4}, Lcom/ironsource/mediationsdk/s;->n(Lcom/ironsource/mediationsdk/s;)Lcom/ironsource/ms;

    move-result-object v4

    invoke-virtual {v2, v3, v4}, Lcom/ironsource/mediationsdk/s;->a(Landroid/content/Context;Lcom/ironsource/ms;)V
    ...
    invoke-virtual {v4}, Lcom/ironsource/ms;->h()Lcom/ironsource/ms$a;

    move-result-object v4

    invoke-virtual {v0, v2, v3, v4}, Lcom/ironsource/mediationsdk/p;->a(JLcom/ironsource/ms$a;)V
    ...
    invoke-direct {v0, v1, v2, v3, v4}, Lcom/ironsource/fq;-><init>(Lcom/ironsource/sf;Lkotlin/jvm/functions/Function0;Lcom/ironsource/yf;Ljava/util/concurrent/Executor;)V
    ...
    invoke-virtual {v0, v1}, Lcom/ironsource/fq;->c(Landroid/content/Context;)V
    ...
    invoke-direct {v1}, Lcom/ironsource/ps;-><init>()V

    invoke-static {v0, v1}, Lcom/ironsource/mediationsdk/s;->a(Lcom/ironsource/mediationsdk/s;Lcom/ironsource/ps;)Lcom/ironsource/ps;

    iget-object v0, p0, Lcom/ironsource/mediationsdk/s$a;->e:Lcom/ironsource/mediationsdk/s;

    invoke-static {v0}, Lcom/ironsource/mediationsdk/s;->q(Lcom/ironsource/mediationsdk/s;)Lcom/ironsource/ps;

    move-result-object v0

    iget-object v1, p0, Lcom/ironsource/mediationsdk/s$a;->e:Lcom/ironsource/mediationsdk/s;

    invoke-static {v1}, Lcom/ironsource/mediationsdk/s;->p(Lcom/ironsource/mediationsdk/s;)Lcom/ironsource/cf;

    move-result-object v1

    invoke-virtual {v0, v1}, Lcom/ironsource/ps;->a(Lcom/ironsource/cf;)V

    iget-object v0, p0, Lcom/ironsource/mediationsdk/s$a;->e:Lcom/ironsource/mediationsdk/s;

    invoke-static {v0}, Lcom/ironsource/mediationsdk/s;->n(Lcom/ironsource/mediationsdk/s;)Lcom/ironsource/ms;

    move-result-object v0

    invoke-virtual {v0}, Lcom/ironsource/ms;->c()Lcom/ironsource/s8;
    ...
    invoke-virtual {v0}, Lcom/ironsource/ms;->g()Ljava/util/List;
    ...
    invoke-virtual {v4}, Lcom/ironsource/ms;->c()Lcom/ironsource/s8;

    move-result-object v4

    invoke-interface {v2, v0, v3, v4}, Lcom/ironsource/no;->a(Ljava/util/List;ZLcom/ironsource/s8;)V
    ...
    invoke-virtual {v0}, Lcom/ironsource/jp$a;->a()V
    ...
    invoke-virtual {v0}, Lcom/ironsource/a4;->i()Lcom/ironsource/ns;

    move-result-object v0

    if-eqz v0, :cond_6

    invoke-virtual {v0}, Lcom/ironsource/ns;->c()Ljava/lang/String;
    ...
    check-cast v1, Lcom/ironsource/no;

    const-string/jumbo v2, "serverResponseIsNotValid"

    invoke-interface {v1, v2}, Lcom/ironsource/no;->d(Ljava/lang/String;)V
    ...
    invoke-interface {v1}, Lcom/ironsource/no;->a()V
    ...
    invoke-interface {v1, v3}, Lcom/ironsource/no;->d(Ljava/lang/String;)V
