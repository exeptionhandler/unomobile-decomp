...
.method public static close(Landroid/webkit/WebMessagePort;)V
    ...
    .line 60
    invoke-static {p0}, Lbitter/jnibridge/a$$ExternalSyntheticApiModelOutline0;->m(Landroid/webkit/WebMessagePort;)V
...
.method public static createWebMessage(Landroidx/webkit/WebMessageCompat;)Landroid/webkit/WebMessage;
    ...
    .line 103
    invoke-static {}, Lbitter/jnibridge/a$$ExternalSyntheticApiModelOutline0;->m()V
    ...
    invoke-static {v0, p0}, Lbitter/jnibridge/a$$ExternalSyntheticApiModelOutline0;->m(Ljava/lang/String;[Landroid/webkit/WebMessagePort;)Landroid/webkit/WebMessage;
...
.method public static createWebMessageChannel(Landroid/webkit/WebView;)[Landroid/webkit/WebMessagePort;
    ...
    .line 181
    invoke-static {p0}, Lbitter/jnibridge/a$$ExternalSyntheticApiModelOutline0;->m(Landroid/webkit/WebView;)[Landroid/webkit/WebMessagePort;
...
.method public static createWebMessageCompat(Landroid/webkit/WebMessage;)Landroidx/webkit/WebMessageCompat;
    ...
    invoke-static {p0}, Lbitter/jnibridge/a$$ExternalSyntheticApiModelOutline0;->m(Landroid/webkit/WebMessage;)Ljava/lang/String;

    move-result-object v1

    .line 114
    invoke-static {p0}, Lbitter/jnibridge/a$$ExternalSyntheticApiModelOutline0;->m(Landroid/webkit/WebMessage;)[Landroid/webkit/WebMessagePort;
...
.method public static getDescription(Landroid/webkit/WebResourceError;)Ljava/lang/CharSequence;
    ...
    .line 132
    invoke-static {p0}, Lbitter/jnibridge/a$$ExternalSyntheticApiModelOutline0;->m(Landroid/webkit/WebResourceError;)Ljava/lang/CharSequence;
...
.method public static getErrorCode(Landroid/webkit/WebResourceError;)I
    ...
    .line 122
    invoke-static {p0}, Lbitter/jnibridge/a$$ExternalSyntheticApiModelOutline0;->m(Landroid/webkit/WebResourceError;)I
...
.method public static getOffscreenPreRaster(Landroid/webkit/WebSettings;)Z
    ...
    .line 148
    invoke-static {p0}, Lbitter/jnibridge/a$$ExternalSyntheticApiModelOutline0;->m(Landroid/webkit/WebSettings;)Z
...
.method public static postMessage(Landroid/webkit/WebMessagePort;Landroid/webkit/WebMessage;)V
    ...
    .line 52
    invoke-static {p0, p1}, Lbitter/jnibridge/a$$ExternalSyntheticApiModelOutline0;->m(Landroid/webkit/WebMessagePort;Landroid/webkit/WebMessage;)V
...
.method public static postVisualStateCallback(Landroid/webkit/WebView;JLandroidx/webkit/WebViewCompat$VisualStateCallback;)V
    ...
    invoke-static {p0, p1, p2, v0}, Lbitter/jnibridge/a$$ExternalSyntheticApiModelOutline0;->m(Landroid/webkit/WebView;JLandroid/webkit/WebView$VisualStateCallback;)V
...
.method public static postWebMessage(Landroid/webkit/WebView;Landroid/webkit/WebMessage;Landroid/net/Uri;)V
    ...
    .line 172
    invoke-static {p0, p1, p2}, Lbitter/jnibridge/a$$ExternalSyntheticApiModelOutline0;->m(Landroid/webkit/WebView;Landroid/webkit/WebMessage;Landroid/net/Uri;)V
...
.method public static setOffscreenPreRaster(Landroid/webkit/WebSettings;Z)V
    ...
    .line 140
    invoke-static {p0, p1}, Lbitter/jnibridge/a$$ExternalSyntheticApiModelOutline0;->m(Landroid/webkit/WebSettings;Z)V
...
.method public static setWebMessageCallback(Landroid/webkit/WebMessagePort;Landroidx/webkit/WebMessagePortCompat$WebMessageCallbackCompat;)V
    ...
    invoke-static {p0, v0}, Lbitter/jnibridge/a$$ExternalSyntheticApiModelOutline0;->m(Landroid/webkit/WebMessagePort;Landroid/webkit/WebMessagePort$WebMessageCallback;)V
...
.method public static setWebMessageCallback(Landroid/webkit/WebMessagePort;Landroidx/webkit/WebMessagePortCompat$WebMessageCallbackCompat;Landroid/os/Handler;)V
    ...
    invoke-static {p0, v0, p2}, Lbitter/jnibridge/a$$ExternalSyntheticApiModelOutline0;->m(Landroid/webkit/WebMessagePort;Landroid/webkit/WebMessagePort$WebMessageCallback;Landroid/os/Handler;)V
