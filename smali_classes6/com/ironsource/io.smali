.class public Lcom/ironsource/io;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/ironsource/io;->f:Ljava/lang/String;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lcom/ironsource/io;->a:Lcom/iab/omid/library/ironsrc/adsession/Partner;

    const/4 v0, 0x0

    iput-boolean v0, p0, Lcom/ironsource/io;->c:Z

    new-instance v0, Ljava/util/HashMap;

    invoke-direct {v0}, Ljava/util/HashMap;-><init>()V

    iput-object v0, p0, Lcom/ironsource/io;->b:Ljava/util/HashMap;

    return-void
.end method

.method private a(Lcom/ironsource/io$a;Lcom/ironsource/wh;)Lcom/iab/omid/library/ironsrc/adsession/AdSession;
    .locals 5
    ...
    iget-object v0, p1, Lcom/ironsource/io$a;->f:Lcom/iab/omid/library/ironsrc/adsession/CreativeType;

    iget-object v1, p1, Lcom/ironsource/io$a;->e:Lcom/iab/omid/library/ironsrc/adsession/ImpressionType;

    iget-object v2, p1, Lcom/ironsource/io$a;->b:Lcom/iab/omid/library/ironsrc/adsession/Owner;

    iget-object v3, p1, Lcom/ironsource/io$a;->c:Lcom/iab/omid/library/ironsrc/adsession/Owner;

    iget-boolean v4, p1, Lcom/ironsource/io$a;->a:Z
    ...
    iget-object v1, p0, Lcom/ironsource/io;->a:Lcom/iab/omid/library/ironsrc/adsession/Partner;

    invoke-interface {p2}, Lcom/ironsource/wh;->getPresentingView()Landroid/webkit/WebView;

    move-result-object v2

    iget-object p1, p1, Lcom/ironsource/io$a;->d:Ljava/lang/String;
...
.method private a(Lorg/json/JSONObject;)V
    ...
    iget-boolean v0, p0, Lcom/ironsource/io;->c:Z
...
# virtual methods
.method public a()Lcom/ironsource/gr;
    .locals 3

    new-instance v0, Lcom/ironsource/gr;

    invoke-direct {v0}, Lcom/ironsource/gr;-><init>()V

    sget-object v1, Lcom/ironsource/io;->f:Ljava/lang/String;
    ...
    invoke-virtual {v0, v2, v1}, Lcom/ironsource/gr;->b(Ljava/lang/String;Ljava/lang/String;)V
    ...
    iget-object v1, p0, Lcom/ironsource/io;->b:Ljava/util/HashMap;
...
.method public a(Landroid/content/Context;)V
    ...
    iput-boolean p1, p0, Lcom/ironsource/io;->c:Z

    :cond_0
    return-void
.end method

.method public a(Lcom/ironsource/io$a;)V
    .locals 2
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/lang/IllegalStateException;,
    ...
    iget-object v0, p1, Lcom/ironsource/io$a;->g:Ljava/lang/String;
    ...
    invoke-direct {p0, p1, v1}, Lcom/ironsource/io;->a(Lcom/ironsource/io$a;Lcom/ironsource/wh;)Lcom/iab/omid/library/ironsrc/adsession/AdSession;
...
.method public b(Lorg/json/JSONObject;)V
    ...
    invoke-direct {p0, p1}, Lcom/ironsource/io;->a(Lorg/json/JSONObject;)V
    ...
    iget-object v0, p0, Lcom/ironsource/io;->b:Ljava/util/HashMap;
...
.method public c(Lorg/json/JSONObject;)V
    ...
    const-string/jumbo v1, "signalLoaded"
...
.method public d(Lorg/json/JSONObject;)V
    ...
    invoke-static {p1}, Lcom/ironsource/io$a;->a(Lorg/json/JSONObject;)Lcom/ironsource/io$a;

    move-result-object p1

    invoke-virtual {p0, p1}, Lcom/ironsource/io;->a(Lcom/ironsource/io$a;)V
