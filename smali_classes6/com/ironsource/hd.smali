...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "adInstancePayload",
        "<init>",
        "(Lcom/ironsource/w2;Lcom/ironsource/b0;Lcom/ironsource/h0;Lcom/ironsource/id;)V",
...
# direct methods
.method public static synthetic $r8$lambda$GudQ4mamXuFEUL1LilFdBUWbTak(Lcom/ironsource/hd;)V
    .locals 0

    invoke-static {p0}, Lcom/ironsource/hd;->b(Lcom/ironsource/hd;)V

    return-void
.end method

.method public static synthetic $r8$lambda$IuJC5Q8b1yyjYT5ndmjH5Qe3d6A(Lcom/ironsource/hd;)V
    .locals 0

    invoke-static {p0}, Lcom/ironsource/hd;->c(Lcom/ironsource/hd;)V

    return-void
.end method

.method public static synthetic $r8$lambda$Xx__0pu47iiQbF4wdrJ9NSGGOyc(Lcom/ironsource/hd;)V
    .locals 0

    invoke-static {p0}, Lcom/ironsource/hd;->e(Lcom/ironsource/hd;)V

    return-void
.end method

.method public static synthetic $r8$lambda$ifAphyQktcMQS8oF-7Zy7u4dimI(Lcom/ironsource/hd;)V
    .locals 0

    invoke-static {p0}, Lcom/ironsource/hd;->a(Lcom/ironsource/hd;)V

    return-void
.end method

.method public static synthetic $r8$lambda$pWe7bnhB6Q6RMXBz3D6ywkNNeU0(Lcom/ironsource/hd;)V
    .locals 0

    invoke-static {p0}, Lcom/ironsource/hd;->f(Lcom/ironsource/hd;)V

    return-void
.end method

.method public static synthetic $r8$lambda$tQXbtBsJbNwzMpwQObg_Eigr_qA(Lcom/ironsource/hd;ILjava/lang/String;)V
    .locals 0

    invoke-static {p0, p1, p2}, Lcom/ironsource/hd;->a(Lcom/ironsource/hd;ILjava/lang/String;)V

    return-void
.end method

.method public static synthetic $r8$lambda$uLBXNnwbxYA51a-UZgTCFjwxRVE(Lcom/ironsource/hd;)V
    .locals 0

    invoke-static {p0}, Lcom/ironsource/hd;->d(Lcom/ironsource/hd;)V

    return-void
.end method

.method public constructor <init>(Lcom/ironsource/w2;Lcom/ironsource/b0;Lcom/ironsource/h0;Lcom/ironsource/id;)V
    .locals 1
    ...
    iput-object p1, p0, Lcom/ironsource/hd;->w:Ljava/lang/ref/WeakReference;
...
.method private final H()V
    ...
    iput-object v0, p0, Lcom/ironsource/hd;->x:Lcom/ironsource/ib;
    ...
    iget-object v0, p0, Lcom/ironsource/hd;->w:Ljava/lang/ref/WeakReference;
    ...
    invoke-interface {v0, p0}, Lcom/ironsource/id;->b(Lcom/ironsource/hd;)V

    :cond_0
    invoke-virtual {p0}, Lcom/ironsource/hd;->c()V
...
.method private final J()V
    ...
    iget-object v0, p0, Lcom/ironsource/hd;->x:Lcom/ironsource/ib;
    ...
    invoke-interface {v0}, Lcom/ironsource/yf;->p()Lcom/ironsource/fg;
    ...
    invoke-interface {v0, v1, v2}, Lcom/ironsource/fg;->a(Ljava/lang/String;Ljava/lang/String;)Lcom/unity3d/mediation/rewarded/LevelPlayReward;
    ...
    invoke-interface {v0, p0, v11}, Lcom/ironsource/id;->a(Lcom/ironsource/hd;Lcom/unity3d/mediation/rewarded/LevelPlayReward;)V
...
.method private final K()V
    ...
    invoke-interface {v0, p0}, Lcom/ironsource/id;->a(Lcom/ironsource/hd;)V
...
.method private static final a(Lcom/ironsource/hd;)V
    .locals 1
    ...
    invoke-direct {p0}, Lcom/ironsource/hd;->H()V

    return-void
.end method

.method private static final a(Lcom/ironsource/hd;ILjava/lang/String;)V
    .locals 1
    ...
    invoke-direct {p0, p1, p2}, Lcom/ironsource/hd;->b(ILjava/lang/String;)V
...
.method private final b(ILjava/lang/String;)V
    ...
    iget-object p1, p0, Lcom/ironsource/hd;->w:Ljava/lang/ref/WeakReference;

    invoke-virtual {p1}, Ljava/lang/ref/Reference;->get()Ljava/lang/Object;

    move-result-object p1

    check-cast p1, Lcom/ironsource/id;

    if-eqz p1, :cond_0

    invoke-interface {p1, p0, v0}, Lcom/ironsource/id;->a(Lcom/ironsource/hd;Lcom/ironsource/mediationsdk/logger/IronSourceError;)V
...
.method private static final b(Lcom/ironsource/hd;)V
    .locals 1
    ...
    invoke-direct {p0}, Lcom/ironsource/hd;->I()V

    return-void
.end method

.method private static final c(Lcom/ironsource/hd;)V
    .locals 1
    ...
    invoke-direct {p0}, Lcom/ironsource/hd;->J()V

    return-void
.end method

.method private static final d(Lcom/ironsource/hd;)V
    .locals 1
    ...
    invoke-direct {p0}, Lcom/ironsource/hd;->K()V

    return-void
.end method

.method private static final e(Lcom/ironsource/hd;)V
    .locals 1
    ...
    invoke-direct {p0}, Lcom/ironsource/hd;->L()V

    return-void
.end method

.method private static final f(Lcom/ironsource/hd;)V
    .locals 1
    ...
    invoke-direct {p0}, Lcom/ironsource/hd;->M()V
...
.method public final a(Landroid/app/Activity;)V
    ...
    const-string/jumbo v1, "showAd - exception = "
    ...
    invoke-direct {p0, v0, p1}, Lcom/ironsource/hd;->b(ILjava/lang/String;)V
...
.method public a(Lcom/ironsource/j0;)V
    ...
    invoke-interface {p1, p0}, Lcom/ironsource/j0;->a(Lcom/ironsource/hd;)V
...
.method public onAdClosed()V
    ...
    new-instance v0, Lcom/ironsource/hd$$ExternalSyntheticLambda2;

    invoke-direct {v0, p0}, Lcom/ironsource/hd$$ExternalSyntheticLambda2;-><init>(Lcom/ironsource/hd;)V
...
.method public onAdEnded()V
    ...
    new-instance v0, Lcom/ironsource/hd$$ExternalSyntheticLambda3;

    invoke-direct {v0, p0}, Lcom/ironsource/hd$$ExternalSyntheticLambda3;-><init>(Lcom/ironsource/hd;)V
...
.method public onAdRewarded()V
    ...
    new-instance v0, Lcom/ironsource/hd$$ExternalSyntheticLambda0;

    invoke-direct {v0, p0}, Lcom/ironsource/hd$$ExternalSyntheticLambda0;-><init>(Lcom/ironsource/hd;)V
...
.method public onAdShowFailed(ILjava/lang/String;)V
    ...
    new-instance v0, Lcom/ironsource/hd$$ExternalSyntheticLambda1;

    invoke-direct {v0, p0, p1, p2}, Lcom/ironsource/hd$$ExternalSyntheticLambda1;-><init>(Lcom/ironsource/hd;ILjava/lang/String;)V
...
.method public onAdShowSuccess()V
    ...
    new-instance v0, Lcom/ironsource/hd$$ExternalSyntheticLambda4;

    invoke-direct {v0, p0}, Lcom/ironsource/hd$$ExternalSyntheticLambda4;-><init>(Lcom/ironsource/hd;)V
...
.method public onAdStarted()V
    ...
    new-instance v0, Lcom/ironsource/hd$$ExternalSyntheticLambda6;

    invoke-direct {v0, p0}, Lcom/ironsource/hd$$ExternalSyntheticLambda6;-><init>(Lcom/ironsource/hd;)V
...
.method public onAdVisible()V
    ...
    new-instance v0, Lcom/ironsource/hd$$ExternalSyntheticLambda5;

    invoke-direct {v0, p0}, Lcom/ironsource/hd$$ExternalSyntheticLambda5;-><init>(Lcom/ironsource/hd;)V
