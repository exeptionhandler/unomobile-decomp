...
.field private gpupboUtil:Lio/agora/base/internal/video/GPUPBOUtil;
...
.method private release()V
    ...
    :cond_1
    iget-object v0, p0, Lio/agora/base/TextureBufferHelper;->gpupboUtil:Lio/agora/base/internal/video/GPUPBOUtil;

    if-eqz v0, :cond_2

    invoke-virtual {v0}, Lio/agora/base/internal/video/GPUPBOUtil;->release()V

    iput-object v1, p0, Lio/agora/base/TextureBufferHelper;->gpupboUtil:Lio/agora/base/internal/video/GPUPBOUtil;
...
.method public dispose()V
    ...
    new-instance v1, Lio/agora/base/TextureBufferHelper$5;

    invoke-direct {v1, p0}, Lio/agora/base/TextureBufferHelper$5;-><init>(Lio/agora/base/TextureBufferHelper;)V
...
.method public parseAlphaData(Lio/agora/base/TextureBuffer;I)Ljava/nio/ByteBuffer;
    .locals 16
    .annotation system Ldalvik/annotation/MethodParameters;
        accessFlags = {
            0x0,
    ...
    :goto_5
    iget-object v3, v0, Lio/agora/base/TextureBufferHelper;->gpupboUtil:Lio/agora/base/internal/video/GPUPBOUtil;

    if-nez v3, :cond_8

    new-instance v3, Lio/agora/base/internal/video/GPUPBOUtil;

    invoke-direct {v3}, Lio/agora/base/internal/video/GPUPBOUtil;-><init>()V

    iput-object v3, v0, Lio/agora/base/TextureBufferHelper;->gpupboUtil:Lio/agora/base/internal/video/GPUPBOUtil;

    :cond_8
    iget-object v4, v0, Lio/agora/base/TextureBufferHelper;->gpupboUtil:Lio/agora/base/internal/video/GPUPBOUtil;

    const/16 v10, 0x1401

    iget-object v11, v0, Lio/agora/base/TextureBufferHelper;->alphaBuffer:Ljava/nio/ByteBuffer;
