...
.method public static final decode(Ljava/nio/charset/CharsetDecoder;Lio/ktor/utils/io/core/Input;Ljava/lang/Appendable;I)I
    ...
    .line 640
    invoke-static {v9, v10, v11}, Lio/ktor/utils/io/bits/Memory;->slice-87lwejk(Ljava/nio/ByteBuffer;II)Ljava/nio/ByteBuffer;
    ...
    .line 234
    invoke-virtual {v1, v8}, Ljava/nio/CharBuffer;->limit(I)Ljava/nio/Buffer;

    .line 236
    :cond_3
    invoke-virtual {p0, v9, v1, v4}, Ljava/nio/charset/CharsetDecoder;->decode(Ljava/nio/ByteBuffer;Ljava/nio/CharBuffer;Z)Ljava/nio/charset/CoderResult;
    ...
    invoke-interface {p2, v10}, Ljava/lang/Appendable;->append(Ljava/lang/CharSequence;)Ljava/lang/Appendable;
    ...
    invoke-static {v8}, Lio/ktor/utils/io/charsets/CharsetJVMKt;->throwExceptionWrapped(Ljava/nio/charset/CoderResult;)V
...
.method private static final decodeImplSlow(Ljava/nio/charset/CharsetDecoder;Lio/ktor/utils/io/core/Input;I)Ljava/lang/String;
    ...
    .line 698
    invoke-static {v10, v12, v13}, Lio/ktor/utils/io/bits/Memory;->slice-87lwejk(Ljava/nio/ByteBuffer;II)Ljava/nio/ByteBuffer;
    ...
    invoke-static {v7}, Lio/ktor/utils/io/charsets/CharsetJVMKt;->throwExceptionWrapped(Ljava/nio/charset/CoderResult;)V
    ...
    .line 703
    invoke-virtual {v8, v7}, Lio/ktor/utils/io/core/Buffer;->discardExact(I)V
...
.method public static final encodeUTF8(Ljava/nio/charset/CharsetEncoder;Lio/ktor/utils/io/core/ByteReadPacket;Lio/ktor/utils/io/core/Output;)V
    ...
    .line 74
    :goto_0
    invoke-virtual/range {p1 .. p1}, Lio/ktor/utils/io/core/ByteReadPacket;->getRemaining()J
    ...
    const-string v12, "Buffer\'s limit change is not allowed"
    ...
    .line 77
    invoke-virtual {v1, v15}, Lio/ktor/utils/io/core/ByteReadPacket;->prepareReadHead$ktor_io(I)Lio/ktor/utils/io/core/internal/ChunkBuffer;
    ...
    .line 85
    invoke-virtual {v7, v4}, Ljava/nio/CharBuffer;->put(C)Ljava/nio/CharBuffer;
    ...
    .line 437
    invoke-virtual {v9, v15}, Lio/ktor/utils/io/core/Buffer;->discardExact(I)V
    ...
    invoke-virtual {v1, v3}, Lio/ktor/utils/io/core/ByteReadPacket;->setHeadPosition(I)V
    ...
    .line 498
    invoke-static {v2, v4, v3}, Lio/ktor/utils/io/core/internal/UnsafeKt;->prepareWriteHead(Lio/ktor/utils/io/core/Output;ILio/ktor/utils/io/core/internal/ChunkBuffer;)Lio/ktor/utils/io/core/internal/ChunkBuffer;
    ...
    .line 514
    invoke-static {v6, v8, v9}, Lio/ktor/utils/io/bits/Memory;->slice-87lwejk(Ljava/nio/ByteBuffer;II)Ljava/nio/ByteBuffer;
    ...
    .line 100
    invoke-virtual {v0, v7, v6, v8}, Ljava/nio/charset/CharsetEncoder;->encode(Ljava/nio/CharBuffer;Ljava/nio/ByteBuffer;Z)Ljava/nio/charset/CoderResult;
    ...
    invoke-static {v10}, Lio/ktor/utils/io/charsets/CharsetJVMKt;->throwExceptionWrapped(Ljava/nio/charset/CoderResult;)V
    ...
    .line 522
    invoke-static {v2, v8, v5}, Lio/ktor/utils/io/core/internal/UnsafeKt;->prepareWriteHead(Lio/ktor/utils/io/core/Output;ILio/ktor/utils/io/core/internal/ChunkBuffer;)Lio/ktor/utils/io/core/internal/ChunkBuffer;
    ...
    :cond_12
    :try_start_4
    invoke-virtual/range {p2 .. p2}, Lio/ktor/utils/io/core/Output;->afterHeadWrite()V
    :try_end_4
    ...
    .line 545
    invoke-static {v5, v6, v8}, Lio/ktor/utils/io/bits/Memory;->slice-87lwejk(Ljava/nio/ByteBuffer;II)Ljava/nio/ByteBuffer;
    ...
    .line 122
    invoke-virtual {v0, v7, v5, v6}, Ljava/nio/charset/CharsetEncoder;->encode(Ljava/nio/CharBuffer;Ljava/nio/ByteBuffer;Z)Ljava/nio/charset/CoderResult;
    ...
    invoke-static {v9}, Lio/ktor/utils/io/charsets/CharsetJVMKt;->throwExceptionWrapped(Ljava/nio/charset/CoderResult;)V
    ...
    .line 550
    invoke-virtual {v4, v5}, Lio/ktor/utils/io/core/Buffer;->commitWritten(I)V
    ...
    .line 562
    :try_start_9
    invoke-virtual {v4, v0}, Lio/ktor/utils/io/core/internal/ChunkBuffer;->commitWritten(I)V
    :try_end_9
    ...
    .line 560
    :try_start_a
    invoke-static {v0, v1}, Lio/ktor/utils/io/internal/jvm/ErrorsKt;->wrongBufferPositionChangeError(II)Ljava/lang/Void;
