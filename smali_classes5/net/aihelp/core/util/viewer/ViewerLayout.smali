...
.method private init(Landroid/content/Context;)V
    ...
    .line 59
    invoke-virtual {p0, p1}, Lnet/aihelp/core/util/viewer/ViewerLayout;->getBackgroundColorByAlpha(F)I

    move-result p1

    invoke-virtual {p0, p1}, Lnet/aihelp/core/util/viewer/ViewerLayout;->setBackgroundColor(I)V

    .line 61
    iget-object p1, p0, Lnet/aihelp/core/util/viewer/ViewerLayout;->rootView:Landroid/view/View;
    ...
    check-cast p1, Lnet/aihelp/core/util/viewer/PhotoView;

    iput-object p1, p0, Lnet/aihelp/core/util/viewer/ViewerLayout;->imageView:Lnet/aihelp/core/util/viewer/PhotoView;

    .line 62
    iget-object p1, p0, Lnet/aihelp/core/util/viewer/ViewerLayout;->rootView:Landroid/view/View;

    const-string v0, "aihelp_video_view"
    ...
    iput-object p1, p0, Lnet/aihelp/core/util/viewer/ViewerLayout;->videoView:Landroid/widget/VideoView;
    ...
    const-string v0, "aihelp_progress_bar"
    ...
    iput-object p1, p0, Lnet/aihelp/core/util/viewer/ViewerLayout;->progressBar:Landroid/widget/ProgressBar;

    .line 66
    iget-object p1, p0, Lnet/aihelp/core/util/viewer/ViewerLayout;->videoView:Landroid/widget/VideoView;

    new-instance v0, Lnet/aihelp/core/util/viewer/ViewerLayout$1;

    invoke-direct {v0, p0}, Lnet/aihelp/core/util/viewer/ViewerLayout$1;-><init>(Lnet/aihelp/core/util/viewer/ViewerLayout;)V
