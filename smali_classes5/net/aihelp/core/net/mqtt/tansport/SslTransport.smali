...
.method public connected(Ljava/nio/channels/SocketChannel;)V
    ...
    iget-object v2, p0, Lnet/aihelp/core/net/mqtt/tansport/SslTransport;->clientAuth:Lnet/aihelp/core/net/mqtt/tansport/SslTransport$ClientAuth;

    invoke-virtual {v2}, Lnet/aihelp/core/net/mqtt/tansport/SslTransport$ClientAuth;->ordinal()I
...
.method public handshake()V
    ...
    const-string v0, "Unexpected ssl engine handshake status: "
    ...
    .line 444
    iget-object v0, p0, Lnet/aihelp/core/net/mqtt/tansport/SslTransport;->drainOutboundSource:Lnet/aihelp/core/net/mqtt/hawtdispatch/CustomDispatchSource;
    ...
    invoke-direct {p0, v0}, Lnet/aihelp/core/net/mqtt/tansport/SslTransport;->secure_read(Ljava/nio/ByteBuffer;)I
    ...
    invoke-direct {p0, v0}, Lnet/aihelp/core/net/mqtt/tansport/SslTransport;->secure_write(Ljava/nio/ByteBuffer;)I
    ...
    invoke-direct {v3, p0, v0}, Lnet/aihelp/core/net/mqtt/tansport/SslTransport$3;-><init>(Lnet/aihelp/core/net/mqtt/tansport/SslTransport;Ljava/lang/Runnable;)V
    ...
    .line 441
    :try_start_2
    invoke-virtual {p0, v0}, Lnet/aihelp/core/net/mqtt/tansport/SslTransport;->onTransportFailure(Ljava/io/IOException;)V
    :try_end_2
    ...
    invoke-interface {v2, v1}, Lnet/aihelp/core/net/mqtt/hawtdispatch/CustomDispatchSource;->merge(Ljava/lang/Object;)V
